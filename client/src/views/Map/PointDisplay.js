...
const PointDisplay = (loading, features, map) =>{
      ...
      map.loadImage(
        ...
        function (error, image) {
          ...
          map.addLayer({
            ...
            'source': unique[index] ,
            'paint': {
              'circle-color': `rgb(${Math.floor(Math.random() * (254 - 1 + 1) ) + 1},${Math.floor(Math.random() * (254 - 1 + 1) ) + 1},${Math.floor(Math.random() * (254 - 1 + 1) ) + 1})`
            }
            // 'layout': {
